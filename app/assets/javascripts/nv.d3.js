        ...
        case 'left':
          ...
          */
          ...
          axisLabel
              ...
              .attr('transform', rotateYLabel ? 'rotate(-90)' : '')
              .attr('y', rotateYLabel ? (-Math.max(margin.left,width) + 25) : -10) //TODO: consider calculating this based on largest tick width... OR at least expose this on chart
              .attr('x', rotateYLabel ? (-scale.range()[0] / 2) : -axis.tickPadding());
          if (showMaxMin) {
            var axisMaxMin = wrap.selectAll('g.nv-axisMaxMin')
                           .data(scale.domain());
...
nv.models.lineChart = function() {
  ...
  var showTooltip = function(e, offsetElement) {
    ...
    nv.tooltip.show([left, top], content, interactiveLayer.tooltip.gravity(), interactiveLayer.tooltip.distance(), offsetElement);
  };
